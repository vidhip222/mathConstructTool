#!/usr/bin/env bash
# =============================================================================
# pace/run_cot_qwen32b.sh — SLURM job: MathConstruct CoT benchmark (Qwen2.5 32B)
# =============================================================================
# Submit AFTER the server job is running:
#
#   SERVER_JOB=$(sbatch --parsable pace/server_qwen32b.sh)
#   sbatch --dependency=after:${SERVER_JOB} pace/run_cot_qwen32b.sh
#
# Adjust --account to match your PACE allocation.
# =============================================================================

#SBATCH --job-name=mc-cot-qwen32b
...
#SBATCH --output=logs/cot_qwen32b_%j.out
#SBATCH --error=logs/cot_qwen32b_%j.err
