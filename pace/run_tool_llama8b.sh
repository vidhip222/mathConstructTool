#!/usr/bin/env bash
# =============================================================================
# pace/run_tool_llama8b.sh — SLURM job: MathConstruct tool benchmark (Llama 3.1 8B)
# =============================================================================
# Submit AFTER the server job is running:
#
#   SERVER_JOB=$(sbatch --parsable pace/server_llama8b.sh)
#   sbatch --dependency=after:${SERVER_JOB} pace/run_tool_llama8b.sh
#
# Adjust --account to match your PACE allocation.
# =============================================================================

#SBATCH --job-name=mc-tool-llama8b
...
#SBATCH --output=logs/tool_llama8b_%j.out
#SBATCH --error=logs/tool_llama8b_%j.err
